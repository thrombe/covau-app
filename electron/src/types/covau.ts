...
export type Artist = { name: string; source: InfoSource | null };
export type Song = { title: string; artists: Artist[]; thumbnails: Thumbnail[]; info_sources: InfoSource[]; play_sources: PlaySource[] };
