...
export type Song<I> = { title: string; key: string; artist_name: string | null; info: I; last_known_path: string | null };
...
export type EntityTracker = { songs: (Song<SongInfo | null>)[]; albums: Album<VideoId>[]; artists: (Artist<VideoId, AlbumId>)[]; playlists: Playlist<VideoId>[]; queues: Queue<VideoId>[] };
