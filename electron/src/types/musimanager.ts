...
export type EntityTracker = { songs: (Song<SongInfo | null>)[]; albums: Album<SongId>[]; artists: (Artist<SongId, AlbumId>)[]; playlists: SongProvider<SongId>[]; queues: SongProvider<SongId>[] };
